    ...
    for row_number, row in _rows(file):
        try:
            ...
            statement = FinancialStatement(
                ...
                statement_kind=_optional(row, "statement_kind"),
                gross_earnings=_optional_decimal(row, "gross_earnings"),
                interest_income=_optional_decimal(row, "interest_income"),
                net_interest_income=_optional_decimal(row, "net_interest_income"),
                customer_deposits=_optional_decimal(row, "customer_deposits"),
                loans_and_advances=_optional_decimal(row, "loans_and_advances"),
                borrowings_total=_optional_decimal(row, "borrowings_total"),
                interest_expense=_optional_decimal(row, "interest_expense"),
                npl_ratio=_optional_decimal(row, "npl_ratio"),
                capital_adequacy_ratio=_optional_decimal(row, "capital_adequacy_ratio"),
                loan_to_deposit_ratio=_optional_decimal(row, "loan_to_deposit_ratio"),
                business_summary=_optional(row, "business_summary"),
                auditor_name=_optional(row, "auditor_name"),
                auditor_opinion=_optional(row, "auditor_opinion"),
                source_document_id=source.id if source else None,
            )
